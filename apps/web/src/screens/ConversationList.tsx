      ...
      <div className="mx-auto w-full max-w-2xl px-4 py-6">
        ...
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-accent-bg text-sm font-bold text-accent-text">
              P
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            {pending > 0 && (
              <button
                ...
                className="relative rounded-lg border border-border-strong p-2 text-text-secondary transition-colors hover:bg-raised"
              >
                <UserPlusIcon />
                <span className="absolute -right-1.5 -top-1.5 flex min-w-[1.1rem] items-center justify-center rounded-full bg-accent px-1 text-center text-xs font-medium leading-[1.1rem] text-white">
                  {pending > 9 ? "9+" : pending}
                </span>
              </button>
            )}

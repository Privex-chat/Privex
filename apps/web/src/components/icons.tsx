// Minimal inline icons (paths adapted from the prior Privex UI kit). currentColor
// so they inherit Tailwind text color.
type P = { className?: string };
const base = "w-5 h-5";

export function AttachIcon({ className = base }: P) {
  return (
...
// Bottom-nav / rail icons (docs 9): Chats, Contacts, Settings.
export function ChatBubbleIcon({ className = base }: P) {
  return (
    <svg viewBox="0 0 24 24" fill="none" strokeWidth={1.5} stroke="currentColor" className={className}>
